const t = function () {
  ...
  return t.prototype.then = function (n, r) {
    ...
    return this.o = function (t) {
      try {
        const i = t.v;
        1 & t.s ? e(o, 1, n ? n(i) : i) : r ? e(o, 1, r(i)) : e(o, 2, i);
      } catch (t) {
        e(o, 2, t);
      }
    }, o;
    ...
    return null === w.get(t) && function (t) {
      ...
      w.set(t, new Promise(function (n, r) {
        ...
        o.onsuccess = function () {
          var i = o.result;
          (function (t, e, n) {
            if (1 !== t.objectStoreNames.length) return n(S(e)), !1;
            if (t.objectStoreNames[0] !== P) return n(S(e)), !1;
            var r = t.transaction(P, "readonly").objectStore(P);
            return !(r.autoIncrement || r.keyPath || r.indexNames.length) || (n(S(e)), !1);
...
var kvStoragePolyfill = new k("default");

export default kvStoragePolyfill;
export { k as StorageArea };
